...
const FOOTER_VISIBILITY_KEY = 'hearmeout:workspace-footer-visible';
...
const MANAGEMENT_LINKS = [
  ...
  { label: 'Overlay', href: `${SPMT_ORIGIN}/embed/overlays?mode=full&app=hearmeout&output=personal`, Icon: PanelsTopLeft },
...
export function SpmtWorkspaceHost() {
  ...
  const refresh = React.useCallback(async () => {
    ...
    try {
      ...
      if (!response.ok) {
        setConnected(false); setTokens(null); setTenantOutputs(null); setLoaded(true); return;
      }
      ...
      setConnected(false); setTokens(null); setTenantOutputs(null); setLoaded(true);
    }
  }, [hiddenRoute]);
